...
const acco = specOffersData.filter(offer => offer.type === 'photoshoot')

const PhotoshootOffPage = () => {
    return (
        <section className='photoshoot-offer__page'>
            <div className='container'>
                <div className='photoshoot-offer__img-block offer-img__block'>
                    <img src="./assets/images/accoDiscPage.png" alt="img"/>
                </div>
                <div className='photoshoot-offer__body offer-page__body'>
...
export default PhotoshootOffPage;